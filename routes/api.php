...
Route::group([
    ...
    Route::get('/department/doctor',[DoctorController::class, 'departmentDoctor']);
    ...
    Route::post('/appoinment/doctor/all-patient/search',[AppointmentController::class,'doctorAllPatientSearch']);
