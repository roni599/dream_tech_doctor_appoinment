...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('hospital/backend/app/assets/bundles/weather-icon/css/weather-icons.min.css') }}">
    <link rel="stylesheet" href="{{ asset('hospital/backend/app/assets/bundles/weather-icon/css/weather-icons-wind.min.css') }}">

    <link rel="shortcut icon" type="image/x-icon" href="{{ asset('hospital/backend/app/assets/img/heartboard-1.png') }}">
