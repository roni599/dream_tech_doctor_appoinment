                                        ...
                                        <div class="row ">
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pl-0">
                                                <div class="banner-img">
                                                    <img src="../../../../../../public/hospital/backend/app/assets/img/banner/1.png"
                                                        alt="">
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="card-statistic-4">
                                    <div class="align-items-center justify-content-between">
                                        <div class="row ">
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pl-0">
                                                <div class="banner-img">
                                                    <img src="../../../../../../public/hospital/backend/app/assets/img/banner/2.png"
                                                        alt="">
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="card-statistic-4">
                                    <div class="align-items-center justify-content-between">
                                        <div class="row ">
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pl-0">
                                                <div class="banner-img">
                                                    <img src="../../../../../../public/hospital/backend/app/assets/img/banner/3.png"
                                                        alt="">
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="card-statistic-4">
                                    <div class="align-items-center justify-content-between">
                                        <div class="row ">
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pl-0">
                                                <div class="banner-img">
                                                    <img src="../../../../../../public/hospital/backend/app/assets/img/banner/4.png"
                                                        alt="">
                                                </div>
                                            </div>
                                        </div>
                                                ...
                                                <td class="text-truncate">
                                                    <ul class="list-unstyled order-list m-b-0 m-b-0">
                                                        <li class="team-member team-member-sm"><img
                                                                class="rounded-circle"
                                                                src="../../../../../../public/hospital/backend/app/assets/img/users/user-8.png"
                                                                alt="user" data-bs-toggle="tooltip" title=""
                                                                data-original-title="Wildan Ahdian"></li>
                                                        <li class="team-member team-member-sm"><img
                                                                class="rounded-circle"
                                                                src="../../../../../../public/hospital/backend/app/assets/img/users/user-9.png"
                                                                alt="user" data-bs-toggle="tooltip" title=""
                                                                data-original-title="John Deo"></li>
                                                        <li class="team-member team-member-sm"><img
                                                                class="rounded-circle"
                                                                src="../../../../../../public/hospital/backend/app/assets/img/users/user-10.png"
                                                                alt="user" data-bs-toggle="tooltip" title=""
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-truncate">
                                                    <ul class="list-unstyled order-list m-b-0 m-b-0">
                                                        <li class="team-member team-member-sm"><img
                                                                class="rounded-circle"
                                                                src="../../../../../../public/hospital/backend/app/assets/img/users/user-1.png"
                                                                alt="user" data-bs-toggle="tooltip" title=""
                                                                data-original-title="Wildan Ahdian"></li>
                                                        <li class="team-member team-member-sm"><img
                                                                class="rounded-circle"
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-truncate">
                                                    <ul class="list-unstyled order-list m-b-0 m-b-0">
                                                        <li class="team-member team-member-sm"><img
                                                                class="rounded-circle"
                                                                src="../../../../../../public/hospital/backend/app/assets/img/users/user-7.png"
                                                                alt="user" data-bs-toggle="tooltip" title=""
                                                                data-original-title="John Deo"></li>
                                                        <li class="team-member team-member-sm"><img
                                                                class="rounded-circle"
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="support-ticket media pb-1 mb-3 d-flex">
                                        <img src="../../../../../../public/hospital/backend/app/assets/img/users/user-1.png"
                                            class="user-img mr-2" alt="">
                                        <div class="flex-1 ms-3">
                                            <div class="badge badge-pill badge-success mb-1 float-right">Feature
                                            </div>
                                    ...
                                    <div class="support-ticket media pb-1 mb-3 d-flex">
                                        <img src="../../../../../../public/hospital/backend/app/assets/img/users/user-2.png"
                                            class="user-img mr-2" alt="">
                                        <div class="flex-1 ms-3">
                                    ...
                                    <div class="support-ticket media pb-1 mb-3 d-flex">
                                        <img src="../../../../../../public/hospital/backend/app/assets/img/users/user-3.png"
                                            class="user-img mr-2" alt="">
                                        <div class="flex-1 ms-3">
                                            ...
                                            <small class="text-muted">Created by <span class="fw-bold font-13">Ashton
                                                    Cox</span>
                                                &nbsp;&nbsp; -2 day ago</small>
                                        </div>
                                    </div>
                                    <div class="support-ticket media pb-1 mb-3 d-flex">
                                        <img src="../../../../../../public/hospital/backend/app/assets/img/users/user-6.png"
                                            class="user-img mr-2" alt="">
                                        <div class="flex-1 ms-3">
                                            <div class="badge badge-pill badge-info mb-1 float-right">Enhancement
                                            </div>
